...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRightIcon className="ds-ml-auto ds-h-4 ds-w-4" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "ds-z-50 ds-min-w-[8rem] ds-overflow-hidden ds-rounded-md ds-border ds-bg-popover ds-p-1 ds-text-popover-foreground ds-shadow-md",
        "data-[state=open]:ds-animate-in data-[state=closed]:ds-animate-out data-[state=closed]:ds-fade-out-0 data-[state=open]:ds-fade-in-0 data-[state=closed]:ds-zoom-out-95 data-[state=open]:ds-zoom-in-95 data-[side=bottom]:ds-slide-in-from-top-2 data-[side=left]:ds-slide-in-from-right-2 data-[side=right]:ds-slide-in-from-left-2 data-[side=top]:ds-slide-in-from-bottom-2",
        className,
      )}
      {...props}
    />
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="ds-absolute ds-left-2 ds-flex ds-h-3.5 ds-w-3.5 ds-items-center ds-justify-center">
      <DropdownMenuPrimitive.ItemIndicator>
        <DotFilledIcon className="ds-h-4 ds-w-4 ds-fill-current" />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
